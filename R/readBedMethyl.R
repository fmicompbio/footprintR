...
#'
#' @return A \code{SummarizedExperiment} object with genomic positions in rows
#'     and samples (the unique names of \code{fnames}) in the columns.
#'
...
#'
#' @export
readBedMethyl <- function(fnames, nrows = Inf, seqlens = NULL, verbose = FALSE) {
    # digest arguments
